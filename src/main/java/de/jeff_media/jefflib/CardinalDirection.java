...
public enum CardinalDirection {
    ...
    public static CardinalDirection fromIndex(int index) {
        switch (index) {
            ...
            case 1: return NORTH_NORTH_WEST;
            case 2: return NORTH_WEST;
            case 3: return WEST_NORTH_WEST;
            case 4: return WEST;
            case 5: return WEST_SOUTH_WEST;
            case 6: return SOUTH_WEST;
            case 7: return SOUTH_SOUTH_WEST;
            case 8: return SOUTH;
            case 9: return SOUTH_SOUTH_EAST;
            case 10: return SOUTH_EAST;
            case 11: return EAST_SOUTH_EASE;
            case 12: return EAST;
            case 13: return EAST_NORTH_EAST;
            case 14: return NORTH_EAST;
            case 15: return NORTH_NORTH_EAST;
    ...
    public String getShortName() {
        switch (this) {
            ...
            case EAST_SOUTH_EASE: return "ESE";
            case EAST: return "E";
            case EAST_NORTH_EAST: return "ENE";
            case NORTH_EAST: return "NE";
            case NORTH_NORTH_EAST: return "NNE";
            case NORTH: return "N";
            case NORTH_NORTH_WEST: return "NNW";
            case NORTH_WEST: return "NW";
            case WEST_NORTH_WEST: return "WNW";
            case WEST: return "W";
            case WEST_SOUTH_WEST: return "WSW";
            case SOUTH_WEST: return "SW";
            case SOUTH_SOUTH_WEST: return "SSW";
            default: return "S";
        }
    }
