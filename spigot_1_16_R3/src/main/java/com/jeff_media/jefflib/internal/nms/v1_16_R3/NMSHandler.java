...
import com.jeff_media.jefflib.internal.nms.v1_16_R3.ai.CustomGoalExecutor;
import com.jeff_media.jefflib.internal.nms.v1_16_R3.ai.HatchedAvoidEntityGoal;
import com.jeff_media.jefflib.internal.nms.v1_16_R3.ai.HatchedJumpController;
import com.jeff_media.jefflib.internal.nms.v1_16_R3.ai.HatchedLookController;
import com.jeff_media.jefflib.internal.nms.v1_16_R3.ai.HatchedMoveController;
import com.jeff_media.jefflib.internal.nms.v1_16_R3.ai.HatchedMoveToBlockGoal;
import com.jeff_media.jefflib.internal.nms.v1_16_R3.ai.HatchedPathNavigation;
...
import net.minecraft.server.v1_16_R3.LootDeserializationContext;
...
public class NMSHandler implements AbstractNMSHandler, AbstractNMSTranslationKeyProvider {
    ...
    private final com.jeff_media.jefflib.internal.nms.v1_16_R3.BukkitUnsafe unsafe = com.jeff_media.jefflib.internal.nms.v1_16_R3.BukkitUnsafe.INSTANCE;
    ...
    @Override
    public PathfinderGoal createTemptGoal(final org.bukkit.entity.Creature entity, final Stream<org.bukkit.Material> materials, final double speed, final boolean canScare) {
    ...
    @Override
    public boolean moveTo(final org.bukkit.entity.Mob entity, final double x, final double y, final double z, final double speed) {
    ...
    public Advancement loadVolatileAdvancement(final NamespacedKey key, final String advancement) {
        ...
        net.minecraft.server.v1_16_R3.Advancement.SerializedAdvancement nms = net.minecraft.server.v1_16_R3.Advancement.SerializedAdvancement.a(jsonobject, new LootDeserializationContext(resourceLocation, NMS.getServer().getLootPredicateManager()));
