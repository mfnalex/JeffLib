...
<dependency>
    ...
    <version><!-- changeme -->14.0.7</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
dependencies {
    implementation 'com.jeff-media.jefflib:jefflib:14.0.7' // Check the latest version in the repository explorer: https://repo.jeff-media.com/#/public/com/jeff-media/jefflib/jefflib/
} 
```
