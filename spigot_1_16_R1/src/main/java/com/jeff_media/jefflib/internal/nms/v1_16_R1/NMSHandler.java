...
public class NMSHandler implements AbstractNMSHandler {
    ...
    public boolean addGoal(final Mob entity, final PathfinderGoal goal, final int priority) {
        ...
        if (goal instanceof net.minecraft.server.v1_16_R1.PathfinderGoal) {
            pathfinderMob.targetSelector.a(priority, (net.minecraft.server.v1_16_R1.PathfinderGoal) goal);
        } else if (goal instanceof CustomGoal) {
            pathfinderMob.targetSelector.a(priority, (net.minecraft.server.v1_16_R1.PathfinderGoal) ((CustomGoal) goal).getExecutor());
        } else {
