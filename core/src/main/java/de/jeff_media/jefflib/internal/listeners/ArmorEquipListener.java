...
import de.jeff_media.jefflib.events.ArmorEquipEvent.EquipMethod;
...
public class ArmorEquipListener implements Listener{
    ...
    public ArmorEquipListener(List<String> blockedMaterials){
    ...
    public final void inventoryClick(final InventoryClickEvent e){
        ...
        if(shift){
            ...
            if(newArmorType != null){
                ...
                if(newArmorType.equals(ArmorType.HELMET) && (equipping == ItemStackUtils.isNullOrEmpty(e.getWhoClicked().getInventory().getHelmet())) || newArmorType.equals(ArmorType.CHESTPLATE) && (equipping ? ItemStackUtils.isNullOrEmpty(e.getWhoClicked().getInventory().getChestplate()) : !ItemStackUtils.isNullOrEmpty(e.getWhoClicked().getInventory().getChestplate())) || newArmorType.equals(ArmorType.LEGGINGS) && (equipping ? ItemStackUtils.isNullOrEmpty(e.getWhoClicked().getInventory().getLeggings()) : !ItemStackUtils.isNullOrEmpty(e.getWhoClicked().getInventory().getLeggings())) || newArmorType.equals(ArmorType.BOOTS) && (equipping ? ItemStackUtils.isNullOrEmpty(e.getWhoClicked().getInventory().getBoots()) : !ItemStackUtils.isNullOrEmpty(e.getWhoClicked().getInventory().getBoots()))){
            ...
            if(numberkey){
                if(e.getClickedInventory().getType().equals(InventoryType.PLAYER)){// Prevents shit in the 2by2 crafting
                    ...
                    if(!ItemStackUtils.isNullOrEmpty(hotbarItem)){// Equipping
                        newArmorType = ArmorType.matchType(hotbarItem);
                        newArmorPiece = hotbarItem;
                        oldArmorPiece = e.getClickedInventory().getItem(e.getSlot());
                    }else{// Unequipping
                        newArmorType = ArmorType.matchType(!ItemStackUtils.isNullOrEmpty(e.getCurrentItem()) ? e.getCurrentItem() : e.getCursor());
                    }
                }
            }else{
                if(ItemStackUtils.isNullOrEmpty(e.getCursor()) && !ItemStackUtils.isNullOrEmpty(e.getCurrentItem())){// unequip with no new item going into the slot.
                    newArmorType = ArmorType.matchType(e.getCurrentItem());
                }
    ...
    public void playerInteractEvent(PlayerInteractEvent e){
        ...
        if(e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK){
            ...
            if(newArmorType != null){
                if(newArmorType.equals(ArmorType.HELMET) && ItemStackUtils.isNullOrEmpty(e.getPlayer().getInventory().getHelmet()) || newArmorType.equals(ArmorType.CHESTPLATE) && ItemStackUtils.isNullOrEmpty(e.getPlayer().getInventory().getChestplate()) || newArmorType.equals(ArmorType.LEGGINGS) && ItemStackUtils.isNullOrEmpty(e.getPlayer().getInventory().getLeggings()) || newArmorType.equals(ArmorType.BOOTS) && ItemStackUtils.isNullOrEmpty(e.getPlayer().getInventory().getBoots())){
    ...
    public void itemBreakEvent(PlayerItemBreakEvent e){
        ...
        if(type != null){
            ...
            if(armorEquipEvent.isCancelled()){
                ...
                }else if(type.equals(ArmorEquipEvent.ArmorType.LEGGINGS)){
                    p.getInventory().setLeggings(i);
                }else if(type.equals(ArmorEquipEvent.ArmorType.BOOTS)){
    ...
    public void playerDeathEvent(PlayerDeathEvent e){
        ...
        for(ItemStack i : p.getInventory().getArmorContents()){
            if(!ItemStackUtils.isNullOrEmpty(i)){
                Bukkit.getServer().getPluginManager().callEvent(new ArmorEquipEvent(p, ArmorEquipEvent.EquipMethod.DEATH, ArmorEquipEvent.ArmorType.matchType(i), i, null));
