...
//        DefaultServiceLocator
        ...
        final List<Material> materials = EnumUtils.getEnumsFromList(Material.class, Arrays.asList("DIRT", "DIAMOND_PICKAXE", "invalid block name", "NETHERITE_SHOVEL"), Collectors.toList());
