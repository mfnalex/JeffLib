...
public class HatchedNBTDataHolder implements NBTDataHolder {

    protected CompoundTag tag;

    protected HatchedNBTDataHolder() {
        // Burchard's constructor
    }

    public HatchedNBTDataHolder(CompoundTag tag) {
        this.tag = tag;
    }
