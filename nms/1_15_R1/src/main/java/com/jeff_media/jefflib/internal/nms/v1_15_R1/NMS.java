...
public final class NMS {
    ...
    public static RecipeItemStack ingredient(final Stream<Material> set) {
        Stream<IMaterial> stream = set.map(CraftMagicNumbers::getItem);
        return RecipeItemStack.a(stream.toArray(IMaterial[]::new));
    }
    ...
    public static net.minecraft.server.v1_15_R1.Block toNms(final Block block) {
