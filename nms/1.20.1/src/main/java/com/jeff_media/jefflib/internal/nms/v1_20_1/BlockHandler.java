...
public class BlockHandler implements AbstractNMSBlockHandler {
    ...
    public void playComposterParticlesAndSound(final org.bukkit.block.Block block, final boolean success) {
        ComposterBlock.handleFill(com.jeff_media.jefflib.internal.nms.v1_20_1.NMS.getLevel(block.getWorld()), com.jeff_media.jefflib.internal.nms.v1_20_1.NMS.getBlockPos(block), success);
    }
}
