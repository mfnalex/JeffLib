...
class NMSBiomeUtils {
    ...
    private final ResourceKey<Registry<Biome>> BIOME_REGISTRY_RESOURCE_KEY = ResourceKey.createRegistryKey(ResourceLocation.withDefaultNamespace("worldgen/biome"));
    ...
    Registry<Biome> getBiomeRegistry() {
        ...
        return dedicatedServer.registryAccess().lookupOrThrow(BIOME_REGISTRY_RESOURCE_KEY);
    }
